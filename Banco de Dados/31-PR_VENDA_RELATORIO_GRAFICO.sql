...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'PR_VENDA_RELATORIO_GRAFICO')
BEGIN
    DROP Procedure PR_VENDA_RELATORIO_GRAFICO
END
GO

CREATE PROCEDURE dbo.PR_VENDA_RELATORIO_GRAFICO
(
